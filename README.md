...
Any type that contains static member named `is_vari_compatible_typelist` which evaluates to true, is considered as a typelist. It shall contain member named `types`, which is vari-compatible typelist.
